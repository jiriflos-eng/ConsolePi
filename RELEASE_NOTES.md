...
- Generic first boot dočasně zpřístupní z IPv4 sítí pouze SSH 22 a web 80/443. Webový průvodce vyžaduje jednorázový 10minutový kód získaný ověřeným SSH klíčem a povinnou management síť; po dokončení se globální pravidlo odstraní.
